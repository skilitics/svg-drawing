...
import { SvgAnimation } from '@svg-drawing-te/animation'
import { Point } from '@svg-drawing-te/core'
import { useEffect, useRef, useCallback, useState } from 'react'
import { Box, Flex, Button, Text } from 'rebass/styled-components'
import Layout from '../../components/Layout'
import { example } from '../../lib/example-svg'
import type { FrameAnimation } from '@svg-drawing-te/animation'
import type { Command } from '@svg-drawing-te/core'
